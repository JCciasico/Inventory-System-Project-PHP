...
if(isset($_POST['searchfil']))
{
    ...
    $query = "select * from table_1 where concat(`id`, `name`, `image`, `price`, `active`) LIKE '%".$search."%'";
...
<body>
    ...
    <div class="ctable-body">
	    ...
	    <div class="categories">
            <a href="#"class="choice-box burger">
                <p>Flame Grilled Burger</p>
            </a>
            <a href="chicken-table.php"class="choice-box chicken">
                <p>Chicken Burger</p>
            </a>
        </div>
        <div class="search-bar">
            <form action="burger-table.php" method="POST" class="search-form">
            ...
            <?php
                require("Controller/connection.php");
                $query =  "select count(*) from table_1 where active = 'Yes'";
        ...
        <form name="form1" action="edit.php" method="GET" class="table-form"> 
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <!-- <td id="act-del" class="text-center">
                                        &nbsp;<a href="Controller/delete.php?Del=<?php echo $id?>"><img src="https://img.icons8.com/color/30/000000/delete-forever.png"/></a>
                                    </td> -->
                                </tr>
                            </tbody>
                        <?php
